...
class JoinGameBoard extends StatefulWidget {

  final String uid;
  final String username;
  final int roomId;

  JoinGameBoard({Key key, @required this.uid, @required this.username, @required this.roomId}) : super(key: key);

  @override
  _JoinGameBoardState createState() => _JoinGameBoardState();
}

class _JoinGameBoardState extends State<JoinGameBoard> {

  void initState() {
    super.initState();
    Get.lazyPut<GameController>(() => GameController());
    Get.find<GameController>().joinGame(widget.uid, widget.username, widget.roomId);
  }
